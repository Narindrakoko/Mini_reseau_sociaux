...
import { View, Text, Button, StyleSheet, ImageBackground, Image, TouchableOpacity, Alert } from 'react-native';
...
function HomeStackScreen() {
  return (
    <HomeStack.Navigator initialRouteName="Home" screenOptions={{ headerShown: false }}>
      ...
      <HomeStack.Screen name='Distance' component={Distance} />
    </HomeStack.Navigator>
  );
}
...
const DistanceStack = createStackNavigator();
function DistanceStackScreen() {
  return (
    <DistanceStack.Navigator screenOptions={{ headerShown: false }}>
      <DistanceStack.Screen name='Distance' component={Distance} />
    </DistanceStack.Navigator>
  );
}
    ...
    <DrawerContentScrollView {...props}>
      ...
      {buttons.map((button, index) => (
        ...
        >
          ...
          <Text style={styles.drawerButtonText}>aaaaaaaaaaaa</Text>
        </TouchableOpacity>
      ))}
...
function LeftDrawerNavigator() {
  return (<>
    ...
    >
      ...
      <LeftDrawer.Screen name="Maps" component={LoginStackScreen} />
      <LeftDrawer.Screen name="Distance" component={DistanceStackScreen} />
    </LeftDrawer.Navigator>
    </>); 
}
...
function HomeTabNavigator() {
  return (
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ color, size }) => {
          ...
          if (route.name === 'HomeBar') {
            ...
            iconName = 'map';
          } else if (route.name === 'DistanceBar') {
            iconName = 'road'; // Utilisation de l'icône 'road' pour 'Distance'
          }
        ...
        tabBarLabel: ({ focused, color, size }) => {
          ...
          return (
            ...
            {route.name === 'HomeBar' ? 'Accueil' : 
             (route.name === 'MapsBar' ? 'Maps' :
             (route.name === 'DistanceBar' ? 'Distance' : 'A propos'))}
          </Text>
          );
        },
    ...
    >
      ...
      <Tab.Screen name='DistanceBar' component={DistanceStackScreen} options={{ title: 'Dist' }} />
